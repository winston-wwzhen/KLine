...
- **332个地级市**: 支持全国332个地级市（含省会、直辖市）天气数据查询
- **5种显示模式**: 原始温度、Z-score标准化、昼夜温差、累积距平、温度加速度
- **数据统计面板**: 实时显示上涨周数、下跌周数、极值、平均变化等统计指标
- **AI智能分析**: 集成智谱AI glm-4-flash，生成具有社交传播属性的2025年度天气报告
  - 🏷️ **关键词标签**：自动提取3-5个关键词，快速把握天气特点
  - ✨ 吸睛标题，制造好奇与共鸣
  - 💬 金句频出，适合做成海报
  - 🎯 情感共鸣，将天气与生活联系
  - 💬 话题讨论，引发用户互动
  - 📝 精简内容，300-400字直击要点
  - 🔁 **弹性重试**：自动处理API限流，带指数退避重试机制
- **社交分享**: 支持分享到好友、朋友圈，适合小红书等平台传播
- **管理后台**: 支持批量生成AI报告，一键同步1660份报告（332城市×5模式）
- **城市切换**: 下拉选择城市，快速切换查看
- **图表交互**: 支持左右滑动、缩放查看K线图
- **红涨绿跌**: 遵循中国股市配色习惯
- **下拉刷新**: 支持下拉刷新数据
...
├── AI_KEYWORDS_FEATURE.md          # 关键词功能设计文档
└── README.md
```
...
完整城市列表请查看：[miniprogram/utils/cities.js](miniprogram/utils/cities.js)
